...
public class Menu {
    ...
    public void execute() {
        ...
        Vehicle v2 = new Vehicle("Renault", "ClioH", ItemCondition.NEW, 30250, 2019, 0, 2.0);
        Vehicle v3 = new Vehicle("Renault", "ClioH", ItemCondition.USED, 21000, 2014, 44555, 2.3);
        ...
        Vehicle v8 = new Vehicle("Renault", "ClioG", ItemCondition.DAMAGED, 5000, 2005, 300250, 2.0);
        Vehicle v9 = new Vehicle("Renault", "Megane", ItemCondition.USED, 21000, 2014, 44555, 2.3);
        ...
        Vehicle v12 = new Vehicle("Volvo", "XC40", ItemCondition.USED, 50233, 2016, 111200, 2.8);
     ...
     //  m.summary();
        ...
        System.out.println("The most popular car in MCTS: " + m.max());
